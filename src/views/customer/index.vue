<template>
  <div class="com_page">
    ...
    <div class="com_filter">
      ...
      <el-select v-model="listQuery.type" placeholder="潜客类型" clearable @change="handleFilter1">
        <el-option v-for="item in types" :key="item.value" :label="item.label" :value="item.value"/>
      </el-select>
      <el-select v-model="listQuery.companyId" placeholder="公司筛选" clearable filterable @change="handleFilter1">
