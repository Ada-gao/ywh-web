<template>
  <el-container style="height: 100%;">
      <el-menu class="el-menu-nav" index="0" :collapse="isCollapse" :router="true" default-active="1">
        ...
        <el-menu-item index="2" v-if="!isSuperAdmin" route="/account"><i class="iconfont icon-zhanghu"/><span slot="title">账户管理</span></el-menu-item>
        ...
        <el-menu-item index="8" v-if="isSuperAdmin" route="/trial"><i class="fa fa-list-ul"/><span slot="title">试用管理</span></el-menu-item>
        <el-menu-item index="9" v-if="isSuperAdmin" route="/check"><i class="iconfont icon-shenheguanli"/><span slot="title">审核管理</span></el-menu-item>
        <el-submenu index="10">
        ...
        <el-menu-item index="11" v-if="isSuperAdmin" route="/system"><i class="iconfont icon-quanxian"/><span slot="title">系统管理</span></el-menu-item>
        <el-menu-item index="12" v-if="isSuperAdmin" route="/feedback"><i class="fa fa-question-circle"/><span slot="title">问题反馈</span></el-menu-item>
      </el-menu>
    <el-container>
      <el-header>
